...
The items below are preserved from durable transcripts. `PHYSICAL_CURRENT_RUNTIME` means bytes were available in this consolidation; `HISTORICAL_*` means identity/status is known but bytes are not included as the old exact ZIP.

## FOOTBALL_MOBILE_TO_PC_MIGRATION_MASTER_v1.zip
- Status: `HISTORICAL_ARTIFACT_NOT_PHYSICALLY_RECOVERED`
- SHA256: `UNKNOWN / not recovered`
- Notes: Early migration master.

## FOOTBALL_MOBILE_TO_PC_MIGRATION_MASTER_v1_1.zip
- Status: `HISTORICAL_VERIFIED_BY_TRANSCRIPT`
- SHA256: `c1c7d5352f94241c5aed771666ad5f723b24593ac7cf8c3bc9bfb0e7d175e1eb`
- Notes: 4931 entries; 0 corrupt; 0 duplicate paths.

## FOOTBALL_MOBILE_TO_PC_MIGRATION_MASTER_STAGE1_XPLAYABLE.zip
- Status: `HISTORICAL_NAME_RECOVERED_FROM_CODEX_LOG`
- SHA256: `UNKNOWN / not recovered`
- Notes: Full name recovered later from Codex log.

## FOOTBALL_PC_3D_READY_PACK_v0_1.zip
- Status: `HISTORICAL_VERIFIED_BY_TRANSCRIPT`
- SHA256: `5b22f66a75e694405273cdb8647084076f621b7d6cc29fc99045a018423e2ef7`
- Notes: 123/123 FBXS + 93/93 nova_player meshes; ball.glb/obj/collision sphere; ball radius ~0.1107703m.

## FOOTBALL_PC_3D_READY_PACK_v0_2.zip
- Status: `HISTORICAL_ARTIFACT_NOT_PHYSICALLY_RECOVERED`
- SHA256: `UNKNOWN / not recovered`
- Notes: Later PC 3D ready evolution.

## FOOTBALL_PLAYER_SYSTEMS_REFERENCE_PACK_v0_1.zip
- Status: `HISTORICAL_ARTIFACT_NOT_PHYSICALLY_RECOVERED`
- SHA256: `UNKNOWN / not recovered`
- Notes: Player systems reference.
