...
def build_report() -> dict:
    ...
    features = [
        ...
        row("Final kick velocity and ball contact", "partial", "partial", "partial_native_differential", "guarded_contract_scaffolded", "blocked",
            ["spmove branch/selection/producer native comparisons", "BallContact rejects unresolved velocity"],
            ["full inventory eligibility/RNG", "GetVHor/GetVVer bases", "GetKickVelocity composition", "BALL_CONTACT.velocity regression"]),
